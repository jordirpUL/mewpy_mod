...
class Expression:
    ...
    def __init__(self,
        ...
        An expression allows symbolic algebra evaluation with GERM model variables or Symbolic-based symbols using
        ...
        :param variables: A dictionary of GERM model variables instances. The GERM model variables that must be associated
